...
class TeamPLayersDaoDababaseTest {
    ...
    fun `write Player And Read In List`()  {
            var players: List<com.skanderjabouzi.nbateamviewer.data.entity.PlayerEntity> = listOf()
            val player: com.skanderjabouzi.nbateamviewer.data.entity.PlayerEntity =
                com.skanderjabouzi.nbateamviewer.data.entity.PlayerEntity(
                    1,
                    1,
                    "G",
                    "1",
