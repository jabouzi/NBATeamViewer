...
class TeamDaoDababaseTest {
    ...
    fun createDb() {
        ...
        db = Room.inMemoryDatabaseBuilder(
            context, com.skanderjabouzi.nbateamviewer.data.repository.db.TeamDatabase::class.java
        ).build()
        teamDao = db.teamDao()
    }
    ...
    fun `write Team And Read In List`() {
        var teams : List<com.skanderjabouzi.nbateamviewer.data.entity.TeamEntity> = listOf()
        val team: com.skanderjabouzi.nbateamviewer.data.entity.TeamEntity =
            com.skanderjabouzi.nbateamviewer.data.entity.TeamEntity(1, "Bummy Team", 44, 44)
